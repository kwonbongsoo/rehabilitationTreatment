...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, apiPrefix, config, document, port;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    port = configService.get('PORT', 3002);
                    return [4 /*yield*/, app.listen(port)];
                case 2:
                    _a.sent();
                    // 서버 시작 후 데이터 초기화 (비동기)
                    setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                        var dataInitializer, error_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 2, , 3]);
                                    dataInitializer = app.get(data_initializer_service_1.DataInitializerService);
                                    return [4 /*yield*/, dataInitializer.initializeData()];
                                case 1:
                                    _a.sent();
                                    return [3 /*break*/, 3];
                                case 2:
                                    error_1 = _a.sent();
                                    console.error('데이터 초기화 중 오류:', error_1);
                                    return [3 /*break*/, 3];
                                case 3: return [2 /*return*/];
                            }
                        });
                    }); }, 2000); // 2초 후 실행
                    console.log("\uD83D\uDE80 Product Domain Server is running on: http://localhost:".concat(port));
