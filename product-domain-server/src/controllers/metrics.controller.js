...
var MetricsController = function () {
    ...
    var MetricsController = _classThis = /** @class */ (function () {
        function MetricsController_1() {
            __runInitializers(this, _instanceExtraInitializers);
        }
        MetricsController_1.prototype.getMetrics = function (res) {
            return __awaiter(this, void 0, void 0, function () {
                var uptime, memoryUsage, metrics;
                return __generator(this, function (_a) {
                    uptime = process.uptime();
                    memoryUsage = process.memoryUsage();
                    metrics = "# HELP product_server_status Product server status\n# TYPE product_server_status gauge\nproduct_server_status{service=\"product-domain-server\"} 1\n\n# HELP process_uptime_seconds Process uptime in seconds\n# TYPE process_uptime_seconds gauge\nprocess_uptime_seconds{service=\"product-domain-server\"} ".concat(uptime, "\n\n# HELP process_memory_rss_bytes Resident memory size in bytes\n# TYPE process_memory_rss_bytes gauge\nprocess_memory_rss_bytes{service=\"product-domain-server\"} ").concat(memoryUsage.rss, "\n\n# HELP nodejs_version_info Node.js version info\n# TYPE nodejs_version_info gauge\nnodejs_version_info{version=\"").concat(process.version, "\",service=\"product-domain-server\"} 1\n");
                    res.set('Content-Type', 'text/plain; charset=utf-8');
                    return [2 /*return*/, res.send(metrics)];
                });
            });
        };
        MetricsController_1.prototype.getHealth = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, {
                            status: 'healthy',
