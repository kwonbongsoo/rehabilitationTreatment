...
const SizeGuide: React.FC = () => {
    ...
    return (
        <div className={styles.container}>
                ...
                <div className={styles.filterGroup}>
                    ...
                    <div className={styles.filterButtons}>
                        {categories.map(category => (
                            <button
                                key={category.value}
                                className={`${styles.filterButton} ${selectedCategory === category.value ? styles.active : ''
                                    }`}
            ...
            </div>            <div className={styles.sizeTable}>
                {selectedType === 'clothing' ? (
                    <div className={styles.clothingTable}>
                        <h3>
                            {selectedCategory === 'women' ? '여성' :
                                selectedCategory === 'men' ? '남성' : '키즈'} 의류 사이즈
                        </h3>
                        <div className={styles.table}>
                            ...
                            {(selectedCategory === 'women' ? womenClothingSizes :
                                selectedCategory === 'men' ? menClothingSizes :
                                    kidsClothingSizes).map((item: ClothingSize, index: number) => (
                    ...
                    <div className={styles.accessoriesTable}>
                        ...
                        <div className={styles.infoCard}>
                            ...
                            <ul>
                                <li><strong>반지:</strong> 내경 기준으로 표기됩니다</li>
                                <li><strong>목걸이:</strong> 길이별로 다양한 옵션 제공</li>
                                <li><strong>팔찌:</strong> 조절 가능한 체인 제공</li>
                                <li><strong>벨트:</strong> 허리둘레 + 10-15cm 여유분</li>
                            </ul>
                        </div>
                    </div>
                )}
