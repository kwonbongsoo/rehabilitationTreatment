...
const Shipping: React.FC = () => {
    ...
    return (
        <div className={styles.container}>
            <Head>
                <title>배송 안내 - StyleShop</title>
                <meta name="description" content="StyleShop의 배송 정책과 옵션을 확인하세요." />
            </Head>
            ...
            {selectedTab === 'tracking' && (
                <div className={styles.tabContent}>
                    ...
                    <div className={styles.trackingTips}>
                        <h3>💡 배송 조회 팁</h3>
                        <ul>
                            <li>주문 완료 후 1-2시간 뒤부터 조회 가능합니다.</li>
                            <li>운송장 번호가 생성되면 SMS로 알려드립니다.</li>
                            <li>배송 완료 후에도 7일간 조회 가능합니다.</li>
                            <li>마이페이지에서도 배송 현황을 확인할 수 있습니다.</li>
                        </ul>
                    </div>
                </div>
            )}
            ...
            {selectedTab === 'policy' && (
                <div className={styles.tabContent}>
                    ...
                    <div className={styles.policySection}>
                        <h3>📦 포장 정책</h3>
                        <ul>
                            <li>친환경 포장재를 사용합니다.</li>
                            <li>상품이 손상되지 않도록 안전하게 포장합니다.</li>
                            <li>여러 상품 주문 시 가능한 한 번에 포장합니다.</li>
                            <li>브랜드별로 개별 포장이 필요한 경우 별도 안내드립니다.</li>
                        </ul>
                    </div>
                    ...
                    <div className={styles.policySection}>
                        <h3>🚛 배송 업체</h3>
                        <ul>
                            <li>주요 택배사: CJ대한통운, 로젠택배, 한진택배</li>
                            <li>당일배송: 자체 배송팀 또는 전문 업체</li>
                            <li>새벽배송: 전문 새벽배송 업체</li>
                            <li>대형 상품: 화물배송 전문 업체</li>
                        </ul>
                    </div>
                    ...
                    <div className={styles.policySection}>
                        ...
                        <ul>
                            ...
                            <li>일요일/공휴일: 배송 휴무</li>
                            <li>당일배송: 오후 2시 이전 주문 시 당일 배송</li>
                        </ul>
                    </div>
