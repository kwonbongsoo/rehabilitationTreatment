            ...
            <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
                ...
                <section style={{ marginBottom: '2rem' }}>
                    ...
                    <p>
                        ...
                        이용 목적이 변경되는 경우에는 개인정보보호법에 따라 별도의 동의를 받는 등
                        필요한 조치를 이행할 예정입니다.
                    </p>
                    <ul>
                        <li>회원 가입 및 관리</li>
                ...
                <section style={{ marginBottom: '2rem' }}>
                    ...
                    <p>
                        회사는 법령에 따른 개인정보 보유사용기간 또는 정보주체로부터
                        개인정보를 수집 시에 동의받은 개인정보 보유사용기간 내에서 개인정보를 처리보유합니다.
                    </p>
                    <ul>
                ...
                <section>
                    ...
                    <p><strong>연락처:</strong> privacy@ecommerce.com</p>
