        ...
        <>
            <div className={styles.container}>
                ...
                <section className={styles.section}>
                    <h2>우리의 비전</h2>
                    <p>
                        우리는 모든 고객이 자신만의 독특한 스타일을 표현할 수 있도록
                        최고 품질의 패션 아이템을 제공합니다. 지속가능한 패션을 통해
                        더 나은 미래를 만들어갑니다.
                    </p>
                </section>
                ...
                <section className={styles.section}>
                    <h2>팀 소개</h2>
                    <p>
                        패션에 대한 열정과 전문성을 가진 다양한 분야의 전문가들이
                        함께 일하고 있습니다. 디자이너, 바이어, 마케터, 개발자 등
                        각 분야의 최고 인재들이 모여 최상의 서비스를 제공합니다.
                    </p>
                </section>
            </div>
        </>
