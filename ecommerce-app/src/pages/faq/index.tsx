    ...
    const faqData: FAQItem[] = [
        {
            ...
            answer: '웹사이트에서 원하는 상품을 선택하고 장바구니에 담은 후 결제를 진행하시면 됩니다. 회원가입 후 주문하시면 주문 내역을 더 쉽게 확인할 수 있습니다.',
            category: 'order'
        },
        {
            id: 2,
            question: '배송은 얼마나 걸리나요?',
            answer: '일반 배송은 주문 후 2-3일, 당일 배송은 오후 2시 이전 주문 시 당일 배송됩니다. 도서산간 지역은 1-2일 추가 소요될 수 있습니다.',
            category: 'shipping'
        },
        {
            id: 3,
            question: '교환/환불은 어떻게 하나요?',
            answer: '상품 수령 후 7일 이내에 교환/환불 신청이 가능합니다. 마이페이지에서 신청하거나 고객센터로 연락주시면 됩니다.',
            category: 'return'
        },
        {
            id: 4,
        ...
        },
        {
            ...
            answer: '각 상품 상세 페이지에서 사이즈 가이드를 확인할 수 있습니다. 브랜드별로 사이즈가 다를 수 있으니 구매 전 반드시 확인해주세요.',
            category: 'size'
        },
        {
            id: 6,
            question: '회원 혜택은 무엇인가요?',
            answer: '회원가입 시 적립금 지급, 생일 쿠폰, 등급별 할인 혜택, 신상품 우선 알림 등 다양한 혜택을 받으실 수 있습니다.',
            category: 'membership'
        },
        {
            id: 7,
            question: '재고가 없는 상품은 언제 입고되나요?',
            answer: '재입고 알림 신청을 하시면 상품이 입고될 때 알림을 보내드립니다. 정확한 입고 일정은 브랜드사 사정에 따라 달라질 수 있습니다.',
            category: 'stock'
        },
        {
            id: 8,
            question: '쿠폰은 어떻게 사용하나요?',
            answer: '결제 시 쿠폰 적용란에서 보유하신 쿠폰을 선택하여 사용하실 수 있습니다. 쿠폰별로 사용 조건이 다르니 확인 후 사용해주세요.',
            category: 'coupon'
        }
    ];
